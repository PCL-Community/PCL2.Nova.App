...
<template>
    <section class="w-full h-full bg-base-300/90 p-[0px]"> 
        <section class="flex flex-col items-center w-full h-full m-[0px] py-6 bg-transparent relative px-0 homefadein">
