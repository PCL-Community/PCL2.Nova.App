...
export function DarkAndThemeToConst(darkMode: boolean, themeMode: number): string {
    let co = [[
        ...
        "rgb(109, 79, 47)",
        "rgb(30, 35, 30)",
        "linear-gradient(to right, #8A4042, #72390E, #008F8F, #34557D, #621212, #59226C, #786F78, #8A4042)",
        "url('/src/assets/images/Themes/PinkDark.png')",
        "rgb(75, 35, 115)",
        "linear-gradient(to right, darkred, darkorange, darkgoldenrod, darkgreen, darkblue, darkorchid, darkviolet, darkred)",
        ...
        "rgb(159, 129, 87)",
        "rgb(50, 55, 60)",
        "linear-gradient(to right, #FA8072, #D2691E, #00FFFF, #6495ED, #B22222, #9932CC, #D8BFD8, #FA8072)",
