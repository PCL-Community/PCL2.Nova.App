<template>
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M13.2991 11V14" stroke="currentColor" stroke-linecap="round"></path>
        <path d="M12 13.25L14.5981 11.75" stroke="currentColor" stroke-linecap="round"></path>
        <path d="M14.5981 13.25L12.0001 11.75" stroke="currentColor" stroke-linecap="round"></path>
    </svg>
</template>
