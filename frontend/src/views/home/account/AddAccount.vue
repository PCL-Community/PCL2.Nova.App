...
import MyNavButton from "../../../components/button/MyNavButton.vue";
...
<template>
  <div style="display: flex; flex-direction: column;">
    <div id="top">
      <MyNavButton :isChecked="current_account == 'Microsoft'"
      ...
      <MyNavButton :isChecked="current_account == 'Offline'"
      ...
      <MyNavButton :isChecked="current_account == 'ThirdParty'"
